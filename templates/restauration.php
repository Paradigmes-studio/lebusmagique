...
<?php if (have_posts()) : ?>
  <?php while (have_posts()) : the_post(); ?>
    ...
    <section class="carte">
        ...
        <div class="accroche">
        Psst ! Pour les jeudis et vendredis midis, et pour les brunchs du dimanche : <a target="_blank" class="cta" style="margin-bottom: 50px;margin-top:45px" href="https://module.lafourchette.com/fr_FR/module/721906-bac11">réservation possible</a>
